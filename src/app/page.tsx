...
// Vitrine : chaque entrée pointe vers le module reel equivalent de la console.
const nav = [
  ["Vue d'ensemble","/console"],["Campagnes","/console/campagnes"],["Listes d'appels","/console/listes-appels"],["Auto-Dialer","/console/auto-dialer"],["File d'appels","/console/file-appels"],
  ["Clients CRM","/console/clients-crm"],["Contacts","/console/contacts"],["Rendez-vous","/console/rendez-vous"],["Segments","/console/contacts"],
  ["Appels en cours","/console/appels"],["Historique","/console/historique"],["Enregistrements","/console/appels"],["Transcriptions","/console/ia-conversationnelle"],
  ["Rapports","/console/analytics"],["Statistiques","/console/analytics"],["Utilisateurs","/console/tenants"],["Rôles & Permissions","/console/tenants"],["Paramètres","/console/developpeur"],["Intégrations","/console/webhooks"],["Logs & Audit","/console/historique"],
];
...
export default function Home(){
  ...
  return <main className="omni-app">
    <aside className="omni-sidebar">
      ...
      <div className="side-section"><span>PLATEFORME</span>{nav.slice(0,9).map(([label,href],i)=><button key={label} className={selected===label?"side-link active":"side-link"} onClick={()=>window.location.assign(href)}><i>{["⌂","◇","▣","☎","↻","♙","♧","◷","◉"][i]}</i>{label}</button>)}</div>
    ...
    <section className="omni-main">
      ...
      <div className="page-head"><div><h1>Bonjour Rogerio !</h1><p>Voici l'état de votre plateforme OmniComm 360° aujourd'hui.</p></div><div className="filters"><a href="/console" style={{background:"#2563eb",color:"#fff",padding:"10px 16px",borderRadius:8,textDecoration:"none",fontWeight:700}}>Ouvrir la console →</a><button onClick={()=>action("Période actuelle : 20 mai — 26 mai 2024")}>20 mai — 26 mai 2024　▣</button></div></div>
